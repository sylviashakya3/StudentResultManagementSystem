...
namespace StudentResultManagementSystem.Server.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentID,UserID,FirstName,LastName,Grade")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentID,UserID,FirstName,LastName,Grade")] Student student)
        {
